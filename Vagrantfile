...
Vagrant.configure('2') do |config|
  ...
  config.vm.hostname = 'postfixadmin-berkshelf'
  ...
  config.vm.network :private_network, ip: '10.73.57.1'
  ...
  config.vm.forward_port 443, 7443
  ...
  config.vm.provision :chef_solo do |chef|
    ...
    chef.run_list = %w(recipe[postfixadmin::default])
  end
end
