...
This will generate the documentation for the source files inside the [*libraries/*](https://github.com/zuazo/postfixadmin-cookbook/tree/master/libraries) directory.
...
The unit test files are placed in the [*test/unit/*](https://github.com/zuazo/postfixadmin-cookbook/tree/master/test/unit) directory.
...
The integration test files are placed in the [*test/integration/*](https://github.com/zuazo/postfixadmin-cookbook/tree/master/test/integration) directory. Some cookbooks required by this tests are in the [*test/cookbooks/*](https://github.com/zuazo/postfixadmin-cookbook/tree/master/test/cookbooks) directory.
